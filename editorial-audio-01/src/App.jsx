...
const data={"id":"editorial-audio-01","kind":"audio","brand":"NOVA","kicker":"Spatial listening system","title":"Silence,\nengineered.","description":"A high-impact audio product experience with an immersive sticky hero, scroll-driven hardware chapters, kinetic specifications, a horizontal finish gallery, and interactive cart controls.","theme":{"accent":"#376dff","surface":"#070b16","text":"#eef3ff","muted":"#94a2be"},"image":"/root/.codex/generated_images/01a010fd-0199-7130-b68e-8a993f9acdc6/exec-ae75bd6d-f0e3-457d-a064-8b45d6394fb7.png","manifesto":"Not louder. Nearer. Every surface, chamber, and signal path tuned to remove the distance.","edition":"H1 / Reference","price":"$640","chapters":[["01","FORM FOLLOWS QUIET","A continuous aluminum arc distributes weight without pressure points."],["02","A ROOM OF YOUR OWN","Adaptive cancellation maps sound around you 48,000 times each second."],["03","HEAR THE AIR","Planar drivers move with near-zero distortion from first transient to final decay."]]}

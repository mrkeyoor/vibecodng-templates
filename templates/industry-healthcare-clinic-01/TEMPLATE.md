# industry-healthcare-clinic-01

Marigold Family Clinic is a primary care pack derived from `local-business-01`. It keeps the verified component provenance, inline attribution comments, and the four-variable `--bw-*` palette contract.
...
Build with `npx vite build --base=/social/templates/industry-healthcare-clinic-01/`.
...
- Fictional business: Marigold Family Clinic, Pune
- Default catalog palette: `mint-ledger`
- Added primary care services, transparent INR consultation fees, doctor credentials, accessibility notes, clinic hours, and an emergency-care notice.
- Reworked gallery content into clinician profiles and retained location and appointment patterns.
- Added original inline SVG care, clinician, map, and identity art.

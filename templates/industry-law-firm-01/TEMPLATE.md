# industry-law-firm-01

Calder & Frost Associates is a complete legal-services template adapted from `local-business-01`. It retains the verified component provenance records, source attribution comments, and the four-variable `--bw-*` palette contract.
...
Source structures were retained while the information architecture, copy, palette, and artwork were rebuilt for a partner-led law firm. Reveals run once, and reduced-motion mode keeps every section visible.

## Pack

- Base skeleton: `local-business-01`
- Default palette: `plum-brass`
- Added practice areas, fee cues, credentials, matter-plan detail, confidentiality language, and Bengaluru contact information
- Replaced cafe imagery with first-party inline SVG artwork based on legal archives and balanced forms

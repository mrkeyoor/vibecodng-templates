# industry-gym-fitness-01

Ironleaf Strength Club is a coaching gym pack derived from `local-business-01`. It keeps the verified component provenance, inline attribution comments, and the four-variable `--bw-*` palette contract.
...
Build with `npx vite build --base=/social/templates/industry-gym-fitness-01/`.
...
- Fictional business: Ironleaf Strength Club, Austin
- Default catalog palette: `graphite-lime`
- Added training tracks, a six-day class schedule, three USD membership tiers, coach-led positioning, and a paid intro offer.
- Reworked the service and visit patterns around training cadence and membership choice.
- Added original inline SVG athlete, barbell, and identity art.

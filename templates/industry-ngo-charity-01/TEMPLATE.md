# industry-ngo-charity-01

Riverbank Foundation is a complete clean-water nonprofit template adapted from `local-business-01`. It retains the verified component provenance records, source attribution comments, and the four-variable `--bw-*` palette contract.
...
Source structures were retained while the information architecture, copy, palette, and artwork were rebuilt for a clean-water nonprofit. Reveals run once, and reduced-motion mode keeps every section visible.

## Pack

- Base skeleton: `local-business-01`
- Default palette: `glacier-blue`
- Added program areas, donation examples, impact measures, project transparency, local ownership, and partnership contact details
- Replaced cafe imagery with first-party inline SVG river-channel and water-point artwork

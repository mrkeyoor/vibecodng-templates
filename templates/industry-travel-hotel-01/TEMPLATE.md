# industry-travel-hotel-01

Juniper House is a complete boutique-hotel template adapted from `local-business-01`. It retains the verified component provenance records, source attribution comments, and the four-variable `--bw-*` palette contract.
...
Source structures were retained while the information architecture, copy, palette, and artwork were rebuilt for a twelve-room hill hotel. Reveals run once, and reduced-motion mode keeps every section visible.

## Pack

- Base skeleton: `local-business-01`
- Default palette: `linen-sage`
- Added room categories and INR rates, a house table sample menu, guest proof, local experiences, and reservation details
- Replaced cafe imagery with first-party inline SVG artwork of the hotel facade and juniper branches

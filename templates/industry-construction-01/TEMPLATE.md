# industry-construction-01

Bastion Build Co is a complete commercial-construction template adapted from `local-business-01`. It retains the verified component provenance records, source attribution comments, and the four-variable `--bw-*` palette contract.
...
Source structures were retained while the information architecture, copy, palette, and artwork were rebuilt for a commercial builder. Reveals run once, and reduced-motion mode keeps every section visible.

## Pack

- Base skeleton: `local-business-01`
- Default palette: `sand-and-cedar`
- Added capabilities, project thresholds, safety and delivery metrics, project controls, and a weekly site-ledger section
- Replaced cafe imagery with first-party inline SVG structural and drawing-grid artwork

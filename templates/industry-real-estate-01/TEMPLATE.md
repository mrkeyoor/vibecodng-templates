# industry-real-estate-01

Hearthstone Realty is a residential real estate pack derived from `local-business-01`. It keeps the verified component provenance, inline attribution comments, and the four-variable `--bw-*` palette contract.
...
Build with `npx vite build --base=/social/templates/industry-real-estate-01/`.
...
- Fictional business: Hearthstone Realty, Bengaluru
- Default catalog palette: `linen-sage`
- Added private property cards, INR listing prices, buyer and seller advisory services, neighbourhood coverage, consultation details, and RERA-aware copy.
- Reframed gallery and visit patterns as a curated residential collection and Bengaluru area map.
- Added original inline SVG architecture, listing, map, and identity art.
